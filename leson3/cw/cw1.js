...
//     document.write(`<div class="card">${simpson.name} ${simpson.surname} <br> age - ${simpson.age} <br> ${simpson.info} <img src=${simpson.photo}></div>`)
// }
//
// document.write(`</div>`)
...
//     document.write(`<div class="product-card"><h3 class="product-title">${product.price} Price - ${product.price}</h3> <img class="product-image" src="${product.image}"> </div>`)
//
// }
// document.write(`</div>`)